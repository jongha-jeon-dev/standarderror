...
- All data in this post is simulated. Ground truth is a GARCH(1,1) path with Student-t(5) shocks, arch 0.25, beta 0.6, persistence 0.85, omega 0.02, 120,000 steps, seed 5, generated by `quantpost.dynamics.sde.garch11`. No market data is used or redistributed, and no company appears.
