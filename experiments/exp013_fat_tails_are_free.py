...
Run: `quantpost run exp013_fat_tails_are_free --publish`
"""
...
CACHE = qp.SETTINGS.build_dir / "cache" / "exp013.json"
...
SCHEDULE_CACHE = qp.SETTINGS.build_dir / "cache" / "exp013_schedules.json"
...
def build() -> Post:
    ...
    post = Post(
        ...
        data_sources=[
            ...
            f"{GARCH['seed']}, generated by `quantpost.dynamics.sde.garch11`. No "
...
if __name__ == "__main__":
    force = bool(os.environ.get("QUANTPOST_FORCE"))
    which = os.environ.get("QUANTPOST_PART", "all")
